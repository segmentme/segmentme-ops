...
export SEGMENTME_DB_CONNECTOR_URI="mongodb://192.168.1.236:27017/test?readPreference=primary&appname=MongoDB%20Compass&ssl=false"
...
export REDIS_HOST="192.168.1.236"
